...
$gridColumns = [
    ...
    [
        ...
        'value' => function($model){
            if ($model->IMAGE_BEFORE_1 != null) {
                return Html::img('http://10.110.52.5:86/uploads/AUDIT_PATROL/' . $model->IMAGE_BEFORE_1, ['width'=>'170px', 'alt' => 'No Image Found...']);
            }
        },
        'width' => '170px',
        'mergeHeader' => true,
    ...
    [
        ...
        'value' => function($model){
            if ($model->IMAGE_AFTER_1 != null) {
                return Html::img('http://10.110.52.5:86/uploads/AUDIT_PATROL/' . $model->IMAGE_AFTER_1, ['width'=>'170px', 'alt' => 'No Image Found...']);
            }
        },
        'width' => '170px',
        'mergeHeader' => true,
