    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
            <?= Html::a('<b><u>Kanban Application</u></b>', Yii::$app->homeUrl . 'kanban-office', ['class' => 'navbar-brand']) ?>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="<?= \Yii::$app->controller->id == 'kanban-office' && \Yii::$app->controller->action->id == 'data' ? 'active' : ''; ?>">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <?php
                    $filename =$session['kanban_office_user'] . '.jpg';
                    $path = \Yii::$app->basePath . '\\web\\uploads\\yemi_employee_img\\' . $filename;
                    if (file_exists($path)) {
                        echo Html::img('@web/uploads/yemi_employee_img/' .$session['kanban_office_user'] . '.jpg', [
                            'class' => 'user-image',
                        ]);
                    } else {
                ...
                <span class="hidden-xs"><?= strtoupper($session['kanban_office_name']); ?></span>
              </a>
