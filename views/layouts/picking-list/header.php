    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
            <?= Html::a('<i class="fa fa-clipboard"> </i> PickingList', Yii::$app->homeUrl . 'fix-asset', ['class' => 'navbar-brand']) ?>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <?php
                    $filename =$session['picking_list_user'] . '.jpg';
                    $path = \Yii::$app->basePath . '\\web\\uploads\\yemi_employee_img\\' . $filename;
                    if (file_exists($path)) {
                        echo Html::img('@web/uploads/yemi_employee_img/' .$session['picking_list_user'] . '.jpg', [
                            'class' => 'user-image',
                        ]);
                    } else {
                ...
                <span class="hidden-xs"><?= strtoupper($session['picking_list_name']); ?></span>
              </a>
