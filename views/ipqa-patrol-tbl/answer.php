...
<div class="giiant-crud cuti-tbl-update">
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'reject_remark')->textArea(['rows' => 4, 'readonly' => 'readonly'])->label('Reject Remark'); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'reject_answer')->textArea(['rows' => 4, 'placeholder' => 'Input Reject Remark Here ...'])->label('Reply'); ?>
            </div>
        </div>
