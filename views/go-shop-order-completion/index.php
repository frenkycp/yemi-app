...
$this->title = [
    'page_title' => 'ORDER PROGRESS MONITOR <span class="japanesse light-green">(配達進捗モニター）</span> | GO-SHOP',
...
<?php $form = ActiveForm::begin([
    'method' => 'get',
    //'layout' => 'horizontal',
    'action' => Url::to(['go-shop-order-completion/index']),
]); ?>
    ...
    <div class="box-body">
        <div class="box-group" id="accordion">
            ...
            foreach ($data as $key => $value) {
                ...
                if ($driver_status == 1) {
                    if ($value['order_from'] == null && $value['last_update'] == null) {
                        $text_status = '<i>New Member</i>';
                    } else {
