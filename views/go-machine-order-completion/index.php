...
$this->title = [
    'page_title' => 'ORDER PROGRESS MONITOR <span class="japanesse text-green"> (配達進捗モニター）</span> | GO-MACHINE',
...
<div class="box box-solid">
    ...
    <div class="box-body">
        ...
        foreach ($fix_data as $key => $value) {
            ...
            if ($value['last_stage'] == 'SETTING') {
                $panel_class = ' box-success';
                $text_status = '<b><u>Machine setting </u></b> on <u>' . $value['to_loc'] . '</u> at <b>' . $last_update . '</b>';
            } elseif ($value['last_stage'] == 'STANDBY'){
                $panel_class = ' box-warning';
                $text_status = '<b><u>Finished</u></b> on <u>' . $value['to_loc'] . '</u> at <b>' . $last_update . '</b>';
