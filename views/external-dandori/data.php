...
$columns = [
    ...
    [
        ...
        'vAlign' => 'middle',
        'enum' => [
            0 => '<span class="text-red">OPEN</span>',
            1 => '<span class="text-yellow">START</span>',
            2 => '<span class="text-light-blue">FINISH</span>',
            3 => '<span class="text-green">HADN OVER</span>',
        ],
        'filter' => [
            0 => 'OPEN',
            1 => 'START',
