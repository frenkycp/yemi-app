...
* @var app\models\search\FixAssetDataSearch $model
...
<div class="asset-tbl-search">
    ...
    'method' => 'get',
		...
		<?php // echo $form->field($model, 'asset_category') ?>
		...
		<?php // echo $form->field($model, 'cost_centre') ?>
		...
		<?php // echo $form->field($model, 'primary_picture') ?>

		<?php // echo $form->field($model, 'FINANCE_ASSET') ?>

		<?php // echo $form->field($model, 'qty') ?>

		<?php // echo $form->field($model, 'AtCost') ?>

		<?php // echo $form->field($model, 'Discontinue') ?>

		<?php // echo $form->field($model, 'DateDisc') ?>
