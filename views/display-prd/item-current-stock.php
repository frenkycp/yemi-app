...
<table class="table summary-tbl">
    <thead>
        <tr>
            ...
            <th class="text-center">SAP Qty</th>
    ...
    <tbody>
        <?php foreach ($data as $key => $value): ?>
            <tr class="text_class">
                ...
                <td class="text-center"><?= round($value['actual'], 1); ?></td>
                <td class="text-center"><?= round($value['sap'], 1); ?></td>
                <td class="text-center"><?= round($value['diff'], 1); ?></td>
            </tr>
        <?php endforeach ?>
    </tbody>
</table>