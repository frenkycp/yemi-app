...
$this->title = [
    'page_title' => 'SCM ORDER vs PRODUCTION OUTPUT <span class="japanesse light-green">(SCM受注対生産出来高)</span>',
    'tab_title' => 'SCM ORDER vs PRODUCTION OUTPUT',
    'breadcrumbs_title' => 'SCM ORDER vs PRODUCTION OUTPUT'
];
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="progress-group">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress-bar-primary progress-bar-striped active" style="width: <?= $last_month_data['output_pct']; ?>%"><?= $last_month_data['output_pct']; ?>%</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="progress-group">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress-bar-primary progress-bar-striped active" style="width: <?= $this_month_data['output_pct']; ?>%"><?= $this_month_data['output_pct']; ?>%</div>
                    </div>
                </div>
            </div>
        </div>
