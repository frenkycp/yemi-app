...
$this->title = [
    'page_title' => 'SHE Patrol Data <span class="japanesse text-green"></span>',
    'tab_title' => 'SHE Patrol Data',
    'breadcrumbs_title' => 'SHE Patrol Data'
];
...
$gridColumns = [
    ...
    [
        ...
        'value' => function($model){
            if ($model->IMAGE_BEFORE_1 != null) {
                return Html::img('http://10.110.52.5:86/uploads/SHE_PATROL/' . $model->IMAGE_BEFORE_1, ['width'=>'170px', 'alt' => 'No Image Found...', 'class' => 'img-before-after']);
            }
        },
        'width' => '170px',
        'mergeHeader' => true,
    ...
    [
        ...
        'value' => function($model){
            if ($model->IMAGE_AFTER_1 != null) {
                return Html::img('http://10.110.52.5:86/uploads/SHE_PATROL/' . $model->IMAGE_AFTER_1, ['width'=>'170px', 'alt' => 'No Image Found...', 'class' => 'img-before-after']);
            }
        },
        'width' => '170px',
        'mergeHeader' => true,
...
/*echo ExportMenu::widget([
        ...
        'onRenderDataCell' => function(PhpOffice\PhpSpreadsheet\Cell\Cell $cell, $content, $model, $key, $index, kartik\export\ExportMenu $widget) {
            ...
            $path = \Yii::$app->basePath . '\\web\\uploads\\SHE_PATROL\\' . $model->IMAGE_BEFORE_1;
