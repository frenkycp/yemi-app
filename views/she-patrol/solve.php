...
$this->title = [
	    'page_title' => 'Covid Patrol Action <span class="japanesse light-green"></span>',
	    'tab_title' => 'Covid Patrol Action',
	    'breadcrumbs_title' => 'Covid Patrol Action'
	];
...
<div class="panel panel-primary">
	<div class="panel-body">
        <div class="row">
            ...
            <div class="col-sm-6">
                <?= $form->field($model, 'TOPIC')->textInput(['readonly' => true])->label('Patrol Category'); ?>
            </div>
        </div>
        ...
        echo $form->field($custom_model, 'upload_after_1')->widget(\kartik\file\FileInput::className(), [
            ...
            'pluginOptions' => [
                ...
                'initialPreview' => $model->IMAGE_AFTER_1 == null ? [] : [
                    Html::img('@web/uploads/COVID_PATROL/' . $model->IMAGE_AFTER_1, ['width' => '100%'])
                ],
            ],
        ])->label('Image After');
        ?>
