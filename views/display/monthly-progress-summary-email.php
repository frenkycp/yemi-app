...
<table class="table summary-tbl">
    <thead>
        <tr>
            ...
            <th class="text-center">PLAN (USD)</th>
            <th class="text-center">ACTUAL (USD)</th>
        ...
        if (count($top_minus) > 0) {
            ...
            <?php foreach ($top_minus as $key => $value): 
                ...
                <tr>
                    ...
                    <td class="text-center"><?= number_format($value->PLAN_AMT); ?></td>
                    <td class="text-center"><?= number_format($value->ACTUAL_AMT_ALLOC); ?></td>
                    <td class="text-center text-red"><?= number_format($value->BALANCE_AMT_ALLOC); ?></td>
                </tr>
            <?php endforeach ?>
        <?php } else {
            echo '<tr>
