...
$this->title = [
    'page_title' => 'SO Achievement <span class="japanesse light-green"></span>',
    'tab_title' => 'SO Achievement',
    'breadcrumbs_title' => 'SO Achievement'
];
    ...
    <tbody>
        <tr>
            ...
            <?php foreach ($tmp_data as $key => $value): ?>
                <td class="text-center bg-black"><?= number_format($value['plan']); ?></td>
            <?php endforeach ?>
        </tr>
        <tr>
            <td colspan="4" class="bg-black"><span class="desc-number">B. </span>ACTUAL Qty</td>
            <?php foreach ($tmp_data as $key => $value): ?>
                <td class="text-center bg-black"><?= number_format($value['actual']); ?></td>
            <?php endforeach ?>
        </tr>
        <tr>
            <td colspan="4" class="bg-black"><span class="desc-number">C. </span>RATIO B/A</td>
            <?php foreach ($tmp_data as $key => $value): ?>
                <td class="text-center bg-black"><?= $value['qty_ratio']; ?>%</td>
            <?php endforeach ?>
        </tr>
        <tr class="" style="">
            <td class="text-center tbl-header" width="100px"></td>
            <td class="text-center tbl-header" width="100px"></td>
            <td class="text-center tbl-header" width="120px"></td>
