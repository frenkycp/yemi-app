        ...
        <table height="472px" class="table table-bordered" style="font-size: 50px; margin-bottom: 0px;" id="yesterday-tbl">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right<?= $yesterday_data['product_balance'] < 0 ? ' text-red' : ''; ?>"><?= number_format($yesterday_data['product_balance']); ?> <span style="font-size: 0.2em; color: white;"> PCS</span></td>
                </tr>
            </tbody>
        </table>
    </div>
