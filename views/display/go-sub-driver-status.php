...
$this->title = [
    'page_title' => 'GO Sub Assy Driver Status <span class="japanesse text-green"></span>',
    'tab_title' => 'GO Sub Assy Driver Status',
    'breadcrumbs_title' => 'GO Sub Assy Driver Status'
];
