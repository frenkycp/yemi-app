...
<div class="giiant-crud cuti-tbl-update">
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'reject_remark')->textArea(['rows' => 2, 'style' => 'resize: none;', 'readonly' => 'readonly'])->label('Reject Remark'); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <?= $form->field($model, 'reject_answer')->textArea(['rows' => 2, 'style' => 'resize: none;', 'placeholder' => 'Input Reject Remark Here ...', 'readonly' => 'readonly'])->label('Reply'); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
