...
//             echo $this->render('_search', ['model' =>$searchModel]);
    ...
    <div class="table-responsive">
        ...
        'panel' => [
            'type' => 'primary',
            'heading' => Html::a('Today', Url::to(['index', 'index_type' => 1]), ['data-pjax' => 0, 'class' => 'btn btn-sm', 'style' => 'background-color: #00c0ef;']) . 
                '&nbsp;&nbsp;' . Html::a('This Month', Url::to(['index']), ['data-pjax' => 0, 'class' => 'btn btn-sm', 'style' => 'background-color: #00c0ef;']),
            'footer' => false,
            'before' => false
        ],
        'beforeHeader'=>[
        ...
        'toolbar' => [
            ...
            'options' => ['colspan'=>4, 'class'=>'text-center warning'],
        ],
        'columns' => [
                /* [
