...
$this->title = [
    'page_title' => 'SHE Patrol Monitoring <span class="japanesse light-green"></span>',
    'tab_title' => 'SHE Patrol Monitoring',
    'breadcrumbs_title' => 'SHE Patrol Monitoring'
];
                ...
                <?php foreach ($outstanding_data as $value): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <?= Html::a('<i class="fa fa-pencil-square-o"></i> Edit', ['/she-patrol/update', 'ID' => $value->ID], ['class' => 'btn btn-primary']); ?>&nbsp;
                            <?= Html::a('<i class="fa fa-thumbs-o-up"></i> Penaganan', ['/she-patrol/solve', 'ID' => $value->ID], ['class' => 'btn btn-warning']); ?>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
