                    ...
                    echo '<div class="box-body">';
                        echo '<div class="nav-tabs-custom">';
                            echo '<ul class="nav nav-tabs">';
                                echo '<li class="active"><a href="#tab_1_' . $key . '" data-toggle="tab">MRP backflush monitor  （MRP払出しモニター)</a></li>';
                                echo '<li><a href="#tab_2_' . $key .'" data-toggle="tab">BOM monitor  （BOM 部品構成モニター）</a></li>';
                            echo '</ul>';
