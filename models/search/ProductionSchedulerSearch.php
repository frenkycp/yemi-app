...
*/
class ProductionSchedulerSearch extends WipHdrDtr
{
	/**
	* @inheritdoc
	*/
	...
	*/
	public function search($params)
	{
		...
		->andWhere(['>', 'act_qty', 0])
		->andWhere('reservation_number is null');
		...
		$dataProvider = new ActiveDataProvider([
			...
			'sort' => [
		        'defaultOrder' => [
		        	...
		        	'parent' => SORT_ASC,
		        	'parent_desc' => SORT_ASC,
		        	'source_date' => SORT_ASC,
		        	'child' => SORT_ASC,
		        	'child_desc' => SORT_ASC,
		        	'period' => SORT_ASC,
		        	'start_date' => SORT_ASC,
