...
return [
[['ID', 'CATEGORY'], 'integer'],
            [['PATROL_PERIOD', 'PATROL_DATE', 'PATROL_DATETIME', 'LOC_ID', 'LOC_DESC', 'LOC_DETAIL', 'TOPIC', 'DESCRIPTION', 'ACTION', 'AUDITOR', 'AUDITEE', 'PIC_ID', 'PIC_NAME', 'USER_ID', 'USER_NAME', 'IMAGE_BEFORE_1', 'IMAGE_AFTER_1', 'STATUS'], 'safe'],
];
}
