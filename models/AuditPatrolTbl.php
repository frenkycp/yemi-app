...
{
    public $upload_before_1, $upload_before_2, $upload_before_3, $upload_after_1, $upload_after_2, $upload_after_3, $total_open, $total_close, $total_5s, $total_safety, $PATROL_PRESIDR_OPEN, $PATROL_PRESIDR_CLOSE, $PATROL_GM_OPEN, $PATROL_GM_CLOSE, $area, $team;
