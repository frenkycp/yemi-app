...
/**
 * This is the base-model class for table "db_owner.TRACE_ITEM_DTR_VIEW".
 *
 ...
 * @property double $LT_ORDER
 * @property string $SAFETY_CATEGORY_1
 * @property string $CRITICAL_CATEGORY
 * @property string $aliasModel
 */
abstract class TraceItemDtrView extends \yii\db\ActiveRecord
{
    ...
    {
        return 'db_owner.TRACE_ITEM_DTR_VIEW';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['LIFE_TIME', 'ISI_DALAM_KEMASAN', 'NILAI_INVENTORY', 'STD_PRICE', 'STD_AMT', 'LT_ORDER'], 'number'],
            [['SERIAL_NO', 'SUPPLIER', 'LOT_NO', 'SURAT_JALAN', 'BENTUK_KEMASAN', 'USER_DESC', 'CATEGORY', 'LOC_DESC', 'ID_STOK', 'SAFETY_CATEGORY_1', 'CRITICAL_CATEGORY'], 'string', 'max' => 50],
            [['ITEM'], 'string', 'max' => 13],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'LT_ORDER' => 'Lt Order',
            'SAFETY_CATEGORY_1' => 'Safety Category 1',
