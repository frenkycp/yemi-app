...
/**
 * This is the base-model class for table "db_owner.sap_gr_gi_by_loc_log".
 *
 * @property string $id
 ...
 */
abstract class SapGrGiByLocLog extends \yii\db\ActiveRecord
{
    ...
    {
        return 'db_owner.sap_gr_gi_by_loc_log';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['category_desc', 'val_cls_desc', 'plant_desc', 'process_desc', 'storage_loc_desc', 'price_type'], 'string', 'max' => 30],
            [['val_cls', 'plant'], 'string', 'max' => 4],
            [['process', 'storage_loc'], 'string', 'max' => 5],
