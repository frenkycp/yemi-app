...
/**
 * This is the base-model class for table "db_owner.WIP_HDR_DTR_UNION".
 *
 ...
 */
abstract class WipHdrDtrUnion extends \yii\db\ActiveRecord
{
    ...
    {
        return 'db_owner.WIP_HDR_DTR_UNION';
    }
