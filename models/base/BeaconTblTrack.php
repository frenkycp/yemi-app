...
/**
 * This is the base-model class for table "db_owner.BEACON_TBL_TRACK".
 *
 * @property string $seq
 * @property string $id
 ...
 */
abstract class BeaconTblTrack extends \yii\db\ActiveRecord
{
    ...
    {
        return 'db_owner.BEACON_TBL_TRACK';
    }
    ...
    {
        return [
            [['start_date', 'distance_last_update', 'review_date', 'current_machine_start', 'upload_date'], 'safe'],
