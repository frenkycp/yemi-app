...
/**
 * This is the base-model class for table "db_owner.PROD_NG_SERNO_VIEW".
 *
 ...
 */
abstract class ProdNgSernoView extends \yii\db\ActiveRecord
{
    ...
    {
        return 'db_owner.PROD_NG_SERNO_VIEW';
    }
    ...
    public function rules()
    {
        return [
            [['detail_id'], 'required'],
            [['img_before', 'img_after', 'action_remark'], 'string'],
            [['create_date', 'last_update', 'post_date', 'emp_join_date', 'created_time', 'updated_time'], 'safe'],
            [['flag_ng', 'id', 'emp_working_month', 'ng_category_id', 'ng_shift', 'inj_set_parameter', 'flag'], 'integer'],
            [['ng_qty', 'total_output', 'ww_total_price'], 'number'],
            [['detail_id', 'serial_no', 'repair_id', 'repair_name', 'user_id', 'document_no', 'loc_desc', 'ng_category_desc', 'ng_category_detail', 'ng_location_id', 'ng_location', 'ng_root_cause', 'attachment', 'defect_category', 'pcb_ng_found', 'pcb_side', 'pcb_problem', 'pcb_occu', 'pcb_process', 'pcb_part_section', 'pcb_pic', 'pcb_repair', 'smt_pic_aoi', 'smt_group_pic', 'next_action'], 'string', 'max' => 50],
