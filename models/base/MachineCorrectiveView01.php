...
/**
 * This is the base-model class for table "db_owner.MACHINE_CORRECTIVE_VIEW_01".
 *
 ...
 */
abstract class MachineCorrectiveView01 extends \yii\db\ActiveRecord
{
    ...
    {
        return 'db_owner.MACHINE_CORRECTIVE_VIEW_01';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['color_stat', 'prepare_time', 'repair_time', 'spare_part_time', 'install_time', 'down_time', 'non_down_time', 'total_seconds'], 'integer'],
            ...
            [['period', 'post_date'], 'string', 'max' => 4000]
        ];
    }
