...
return [
    ...
    'covid_patrol_category' => [
        'Penggunaan APD (Masker / Faceshield) 保護具（マスク・フェースシールド）の着用' => 'Penggunaan APD (Masker / Faceshield) 保護具（マスク・フェースシールド）の着用',
        'Physical Distance  フィジカルディスタンス' => 'Physical Distance  フィジカルディスタンス',
        'Optimalisasi Srkulasi Udara  空気循環の最適化' => 'Optimalisasi Srkulasi Udara  空気循環の最適化',
        'Cuci tangan/ Hand Sanitizer  手洗い・手指消毒剤' => 'Cuci tangan/ Hand Sanitizer  手洗い・手指消毒剤',
        'Kondisi Partisi  パーテーションの状態' => 'Kondisi Partisi  パーテーションの状態',
        'Lain-lain  その他' => 'Lain-lain  その他',
    ],
    'covid_patrol_loc' => [
