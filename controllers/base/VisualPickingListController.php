...
use app\models\VisualPickingList;
    use app\models\search\VisualPickingListSearch;
...
/**
* VisualPickingListController implements the CRUD actions for VisualPickingList model.
*/
class VisualPickingListController extends Controller
{
...
{
    $searchModel  = new VisualPickingListSearch;
