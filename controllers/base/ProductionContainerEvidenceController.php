...
use app\models\SernoOutput;
    use app\models\search\ProductionContainerEvidenceSearch;
...
/**
* ProductionContainerEvidenceController implements the CRUD actions for SernoOutput model.
*/
class ProductionContainerEvidenceController extends Controller
{
...
{
    $searchModel  = new ProductionContainerEvidenceSearch;
