...
/**
* AssetLogController implements the CRUD actions for AssetLogTbl model.
*/
...
/**
* Displays a single AssetLogTbl model.
...
/**
* Creates a new AssetLogTbl model.
...
/**
* Updates an existing AssetLogTbl model.
...
/**
* Deletes an existing AssetLogTbl model.
...
/**
* Finds the AssetLogTbl model based on its primary key value.
* If the model is not found, a 404 HTTP exception will be thrown.
* @param integer $trans_id
* @return AssetLogTbl the loaded model
* @throws HttpException if the model cannot be found
*/
protected function findModel($trans_id)
{
if (($model = AssetLogTbl::findOne($trans_id)) !== null) {
return $model;
} else {
