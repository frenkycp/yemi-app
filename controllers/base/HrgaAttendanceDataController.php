...
/**
* Creates a new AbsensiTbl model.
* If creation is successful, the browser will be redirected to the 'view' page.
* @return mixed
*/
public function actionCreate()
{
$model = new AbsensiTbl;

try {
if ($model->load($_POST) && $model->save()) {
return $this->redirect(['view', 'NIK_DATE_ID' => $model->NIK_DATE_ID]);
...
/**
* Updates an existing AbsensiTbl model.
* If update is successful, the browser will be redirected to the 'view' page.
* @param string $NIK_DATE_ID
* @return mixed
*/
public function actionUpdate($NIK_DATE_ID)
{
$model = $this->findModel($NIK_DATE_ID);
...
/**
* Deletes an existing AbsensiTbl model.
* If deletion is successful, the browser will be redirected to the 'index' page.
* @param string $NIK_DATE_ID
* @return mixed
*/
public function actionDelete($NIK_DATE_ID)
{
try {
$this->findModel($NIK_DATE_ID)->delete();
} catch (\Exception $e) {
$msg = (isset($e->errorInfo[2]))?$e->errorInfo[2]:$e->getMessage();
