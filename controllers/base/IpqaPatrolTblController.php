...
/**
* IpqaPatrolTblController implements the CRUD actions for IpqaPatrolTbl model.
*/
class IpqaPatrolTblController extends Controller
{
...
/**
* Displays a single IpqaPatrolTbl model.
* @param integer $id
*
* @return mixed
*/
...
* @param integer $id
* @return IpqaPatrolTbl the loaded model
* @throws HttpException if the model cannot be found
*/
protected function findModel($id)
{
if (($model = IpqaPatrolTbl::findOne($id)) !== null) {
return $model;
} else {
