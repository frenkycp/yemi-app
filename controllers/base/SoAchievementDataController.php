...
use app\models\SernoOutput;
    use app\models\search\SoAchievementDataSearch;
...
/**
* SoAchievementDataController implements the CRUD actions for SernoOutput model.
*/
class SoAchievementDataController extends Controller
{
...
{
    $searchModel  = new SoAchievementDataSearch;
