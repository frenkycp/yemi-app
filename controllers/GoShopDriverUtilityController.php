...
use app\models\PalletUtilityView203;
use yii\helpers\ArrayHelper;

class GoShopDriverUtilityController extends Controller
{
    ...
    public function actionIndex()
    {
		...
		$utility_data_arr = PalletUtilityView203::find()
    ...
    public function getCategoriesArr()
	{
		...
		$data_arr = ArrayHelper::getColumn(
			PalletUtilityView203::find()->select('DISTINCT(order_date)')
