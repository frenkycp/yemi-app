...
class PartsPickingPtsGmcController extends Controller
{
    ...
    public function actionIndex()
    {
    	...
    	foreach ($pts_data_arr as $pts_data) {
    		...
    		$tmp_data[] = [
                ...
                'url' => Url::to(['get-remark', 'start_period' => $start_period, 'end_period' => $end_period, 'parent' => $pts_data['parent'], 'parent_desc' => $pts_data['parent_desc']]),
            ];
    	}
    ...
    public function actionGetRemark($start_period, $end_period, $parent, $parent_desc)
    {
