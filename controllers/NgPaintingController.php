...
use app\models\NgPaintingModel;
...
class NgPaintingController extends Controller
{
	...
	{
		if (($model = NgPaintingModel::findOne($id)) !== null) {
			return $model;
		} else {
